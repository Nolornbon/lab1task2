...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(181, 74);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Bookman Old Style", 13.8F, System::Drawing::FontStyle::Italic, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label2->Location = System::Drawing::Point(181, 130);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(321, 78);
			...
			this->pictureBox1->Location = System::Drawing::Point(1, 40);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(185, 198);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(253, 206);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(360, 206);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		else if (textBox1->Text == "2M" && textBox2->Text == "014") {
			this->Hide();
